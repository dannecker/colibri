...
describe 'orders' do
  ...
  it "can visit an order" do
    ...
    lambda { visit colibri.order_path(order) }.should_not raise_error
  end
  ...
  it "should display line item price" do
    ...
    # Tests view colibri/shared/_order_details
    within 'td.price' do
  ...
  it "should return the correct title when displaying a completed order" do
    ...
    within '#order_summary' do
      page.should have_content("#{Colibri.t(:order)} #{order.number}")
    end
  end
end
