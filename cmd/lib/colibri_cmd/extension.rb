module ColibriCmd
  ...
  class Extension < Thor::Group
    ...
    desc "builds a colibri extension"
    ...
    def final_banner
      say %Q{
        ...
        Your extension has been generated with a gemspec dependency on Colibri #{colibri_version}.

        Please update the Versionfile to designate compatibility with different versions of Colibri.
        See http://colibricommerce.com/documentation/extensions.html#versionfile

        Consider listing your extension in the official extension registry http://colibricommerce.com/extensions"
