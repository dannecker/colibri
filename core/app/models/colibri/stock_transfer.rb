module Colibri
  class StockTransfer < Colibri::Base
    ...
    def source_movements
      stock_movements.joins(:stock_item)
        .where('colibri_stock_items.stock_location_id' => source_location_id)
    end

    def destination_movements
      stock_movements.joins(:stock_item)
        .where('colibri_stock_items.stock_location_id' => destination_location_id)
    end
