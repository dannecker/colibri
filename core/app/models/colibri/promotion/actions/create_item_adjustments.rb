      ...
      class CreateItemAdjustments < PromotionAction
        ...
        private
          ...
          def deals_with_adjustments
            adjustment_scope = Adjustment.includes(:order).references(:colibri_orders)
            # For incomplete orders, remove the adjustment completely.
            adjustment_scope.where("colibri_orders.completed_at IS NULL").each do |adjustment|
              adjustment.destroy
            end
            ...
            adjustment_scope.where("colibri_orders.completed_at IS NOT NULL").each do |adjustment|
