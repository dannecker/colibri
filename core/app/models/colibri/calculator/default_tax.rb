...
module Colibri
  class Calculator::DefaultTax < Calculator
    def self.description
      Colibri.t(:default_tax)
    end

    # Default tax calculator still needs to support orders for legacy reasons
    # Orders created before Colibri 2.1 had tax adjustments applied to the order, as a whole.
    # Orders created with Colibri 2.2 and after, have them applied to the line items individually.
