module Colibri
  class Taxon < Colibri::Base
    acts_as_nested_set dependent: :destroy

    belongs_to :taxonomy, class_name: 'Colibri::Taxonomy', inverse_of: :taxons
    ...
    has_attached_file :icon,
      ...
      default_style: :mini,
      url: '/colibri/taxons/:id/:style/:basename.:extension',
      path: ':rails_root/public/colibri/taxons/:id/:style/:basename.:extension',
      default_url: '/assets/default_taxon.png'

    include Colibri::Core::ProductFilters  # for detailed defs of filters
    ...
    def applicable_filters
      ...
      fs << Colibri::Core::ProductFilters.price_filter if Colibri::Core::ProductFilters.respond_to?(:price_filter)
      fs << Colibri::Core::ProductFilters.brand_filter if Colibri::Core::ProductFilters.respond_to?(:brand_filter)
      fs
    end
