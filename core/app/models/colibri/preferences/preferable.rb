...
# Examples:
#
#   # Colibri::Base includes Preferable and defines preferences as a serialized
#   # column.
#   class Settings < Colibri::Base
...
#   s.save!
module Colibri::Preferences::Preferable
  extend ActiveSupport::Concern

  included do
    extend Colibri::Preferences::PreferableClassMethods
  end
