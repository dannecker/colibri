...
class DummyShippingCalculator < Colibri::ShippingCalculator
end

describe Colibri::ShippingMethod do
  let(:shipping_method){ create(:shipping_method) }

  context 'calculators' do
    it "Should reject calculators that don't inherit from Colibri::ShippingCalculator" do
      Colibri::ShippingMethod.stub_chain(:colibri_calculators, :shipping_methods).and_return([
        Colibri::Calculator::Shipping::FlatPercentItemTotal,
        Colibri::Calculator::Shipping::PriceSack,
        Colibri::Calculator::DefaultTax,
        DummyShippingCalculator # included as regression test for https://github.com/colibri/colibri/issues/3109
      ])

      Colibri::ShippingMethod.calculators.should == [Colibri::Calculator::Shipping::FlatPercentItemTotal, Colibri::Calculator::Shipping::PriceSack, DummyShippingCalculator ]
      Colibri::ShippingMethod.calculators.should_not == [Colibri::Calculator::DefaultTax]
    end
  end
