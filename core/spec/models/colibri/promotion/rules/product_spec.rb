...
describe Colibri::Promotion::Rules::Product do
  let(:rule) { Colibri::Promotion::Rules::Product.new }
  ...
  context "#eligible?(order)" do
    ...
    before do
      3.times { |i| instance_variable_set("@product#{i}", mock_model(Colibri::Product)) }
    end
