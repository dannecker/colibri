...
describe Colibri::Promotion::Actions::CreateLineItems do
  let(:order) { create(:order) }
  let(:action) { Colibri::Promotion::Actions::CreateLineItems.create }
  let(:promotion) { stub_model(Colibri::Promotion) }
