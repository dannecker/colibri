...
describe Colibri::OrderContents do
  ...
  context "#add" do
    ...
    context "running promotions" do
      ...
      let(:calculator) { Colibri::Calculator::FlatRate.new(:preferred_amount => 10) }
      ...
      context "one active order promotion" do
        let!(:action) { Colibri::Promotion::Actions::CreateAdjustment.create(promotion: promotion, calculator: calculator) }
      ...
      context "one active line item promotion" do
        let!(:action) { Colibri::Promotion::Actions::CreateItemAdjustments.create(promotion: promotion, calculator: calculator) }
