...
describe Colibri::OrderInventory do
  ...
  context "#add_to_shipment" do
    ...
    context "store doesnt track inventory" do
      ...
      before { Colibri::Config.track_inventory_levels = false }
    ...
    context '#remove_from_shipment' do
      ...
      it 'should destroy backordered units first' do
        shipment.stub(inventory_units_for_item: [
          mock_model(Colibri::InventoryUnit, :variant_id => variant.id, :state => 'backordered'),
          mock_model(Colibri::InventoryUnit, :variant_id => variant.id, :state => 'on_hand'),
          mock_model(Colibri::InventoryUnit, :variant_id => variant.id, :state => 'backordered')
        ])
      ...
      it 'should destroy unshipped units first' do
        shipment.stub(inventory_units_for_item: [
          mock_model(Colibri::InventoryUnit, :variant_id => variant.id, :state => 'shipped'),
          mock_model(Colibri::InventoryUnit, :variant_id => variant.id, :state => 'on_hand')
        ])
