...
describe Colibri::Store do
  ...
  describe ".by_url" do 
    ...
    it "should find stores by url" do
      by_domain = Colibri::Store.by_url('www.subdomain.com')
  ...
  describe '.current' do
    let!(:store_1) { create(:store, default: true, url: 'colibricommerce.com') }
    ...
    it 'should return store for domain' do
      expect(subject.class.current('colibricommerce.com')).to eql(store_1)
  ...
  describe ".default" do
    ...
    it "should ensure there is only one default" do
      ...
      Colibri::Store.where(default: true).count.should == 1
