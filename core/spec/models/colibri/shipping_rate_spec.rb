...
describe Colibri::ShippingRate do
  let(:shipment) { create(:shipment) }
  let(:shipping_method) { create(:shipping_method) }
  let(:shipping_rate) { Colibri::ShippingRate.new(:shipment => shipment,
  ...
  context "#display_price" do
    ...
    context "when the currency is JPY" do
      let(:shipping_rate) { shipping_rate = Colibri::ShippingRate.new(:cost => 205)
