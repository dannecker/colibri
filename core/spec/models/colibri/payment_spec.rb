...
describe Colibri::Payment do
  let(:order) { Colibri::Order.create }

  let(:gateway) do
    gateway = Colibri::Gateway::Bogus.new(:environment => 'test', :active => true)
    gateway.stub :source_required => true
    gateway
  end

  let(:card) do
    mock_model(Colibri::CreditCard, :number => "4111111111111111",
                                  :has_payment_profile? => true)
  end

  let(:payment) do
    payment = Colibri::Payment.new
    payment.source = card
    payment.order = order
  ...
  context 'validations' do
    it "returns useful error messages when source is invalid" do
      payment.source = Colibri::CreditCard.new
  ...
  # Regression test for https://github.com/colibri/colibri/pull/2224
  context 'failure' do
  ...
  context "processing" do
    ...
    describe "#process!" do
      ...
      it "should invalidate if payment method doesnt support source" do
        ...
        expect { payment.process!}.to raise_error(Colibri::Core::GatewayError)
        payment.state.should eq('invalid')
      end
    ...
    describe "#authorize!" do
      ...
      context "when gateway does not match the environment" do
        it "should raise an exception" do
          ...
          expect { payment.authorize! }.to raise_error(Colibri::Core::GatewayError)
        end
      end
      ...
      context "if unsuccessful" do
        it "should mark payment as failed" do
          ...
          lambda {
            payment.authorize!
          }.should raise_error(Colibri::Core::GatewayError)
        end
      end
    end
    ...
    describe "#purchase!" do
      ...
      context "when gateway does not match the environment" do
        it "should raise an exception" do
          gateway.stub :environment => "foo"
          expect { payment.purchase!  }.to raise_error(Colibri::Core::GatewayError)
        end
      end
      ...
      context "when payment is pending" do
        ...
        context "if unsuccessful" do
          it "should not make payment complete" do
            ...
            expect { payment.capture! }.to raise_error(Colibri::Core::GatewayError)
          end
        end
      end
    ...
    describe "#void_transaction!" do
      ...
      context "when gateway does not match the environment" do
        it "should raise an exception" do
          gateway.stub :environment => "foo"
          expect { payment.void_transaction! }.to raise_error(Colibri::Core::GatewayError)
        end
      end
    ...
    describe "#credit!" do
      ...
      context "when gateway does not match the environment" do
        it "should raise an exception" do
          gateway.stub :environment => "foo"
          lambda { payment.credit! }.should raise_error(Colibri::Core::GatewayError)
        end
      end

      context "when response is successful" do
        it "should create an offsetting payment" do
          Colibri::Payment.should_receive(:create!)
          payment.credit!
        end
  ...
  context "when response is unsuccessful" do
    it "should not create a payment" do
      ...
      Colibri::Payment.should_not_receive(:create)
      expect { payment.credit! }.to raise_error(Colibri::Core::GatewayError)
    end
  end
  ...
  context "with source required" do
    context "raises an error if no source is specified" do
      ...
      specify do
        expect { payment.process! }.to raise_error(Colibri::Core::GatewayError, Colibri.t(:payment_processing_failed))
      end
    end
  end
  ...
  describe "#save" do
    context "completed payments" do
      it "updates order payment total" do
        payment = Colibri::Payment.create(:amount => 100, :order => order, state: "completed")
    ...
    context "not completed payments" do
      it "doesn't update order payment total" do
        expect {
          Colibri::Payment.create(:amount => 100, :order => order)
    ...
    context "when profiles are supported" do
      ...
      context "when there is an error connecting to the gateway" do
        it "should call gateway_error " do
          ...
          lambda do
            Colibri::Payment.create(
              :amount => 100,
              :order => order,
              :source => card,
              :payment_method => gateway
            )
          end.should raise_error(Colibri::Core::GatewayError)
        end
      end
      ...
      context "when successfully connecting to the gateway" do
        it "should create a payment profile" do
          ...
          payment = Colibri::Payment.create(
            :amount => 100,
            :order => order,
            :source => card,
            :payment_method => gateway
  ...
  describe "#build_source" do
    ...
    it "should build the payment's source" do
      payment = Colibri::Payment.new(params)
  ...
  describe "#display_amount" do
    it "returns a Colibri::Money for this amount" do
      payment.display_amount.should == Colibri::Money.new(payment.amount)
    end
  end
