...
# Chosed the colibri_payment_methods table because it has a `name` column
...
module Colibri
  class DelegateBelongsToStubModel < Colibri::Base
    self.table_name = "colibri_payment_methods"
    belongs_to :product
