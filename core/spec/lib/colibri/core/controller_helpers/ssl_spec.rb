...
describe Colibri::Core::ControllerHelpers::SSL, :type => :controller do
  controller do
  ...
  describe 'redirect to http' do
    before { Colibri::Config[:redirect_https_to_http] = true  }
    after  { Colibri::Config[:redirect_https_to_http] = false }
