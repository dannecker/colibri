...
module Colibri
  class DummyGenerator < Rails::Generators::Base
    desc "Creates blank Rails application, installs Colibri and all sample data"
    ...
    def test_dummy_inject_extension_requirements
      if DummyGeneratorHelper.inject_extension_requirements
        inside dummy_path do
          inject_require_for('colibri_frontend')
          inject_require_for('colibri_backend')
          inject_require_for('colibri_api')
        end
      end
    end
...
begin
  ...
  # #{requirement} is not available.
    ...
    def gemfile_path
      core_gems = ["colibri/core", "colibri/api", "colibri/backend", "colibri/frontend"]
...
module Colibri::DummyGeneratorHelper
