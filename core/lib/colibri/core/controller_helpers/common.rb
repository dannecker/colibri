      ...
      module Common
        ...
        included do
          ...
          def default_notification_payload
            {:user => try_colibri_current_user, :order => current_order}
          end
          ...
          def title
            ...
            if title_string.present?
              if Colibri::Config[:always_put_site_name_in_title]
          ...
          # 
          # You can set the layout you want to render inside your Colibri configuration with the +:layout+ option.
          # 
          # Default layout is: +app/views/colibri/layouts/colibri_application+
          # 
          def get_layout
            layout ||= Colibri::Config[:layout]
          end
