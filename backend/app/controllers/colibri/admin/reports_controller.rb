module Colibri
  module Admin
    class ReportsController < Colibri::Admin::BaseController
      respond_to :html
      ...
      class << self
        ...
        def add_available_report!(report_key, report_description_key = nil)
          ...
          @@available_reports[report_key] = {name: Colibri.t(report_key), description: Colibri.t(report_description_key)}
        end
      end
      ...
      def model_class
        Colibri::Admin::ReportsController
      end
