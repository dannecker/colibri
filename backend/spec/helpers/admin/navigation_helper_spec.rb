...
describe Colibri::Admin::NavigationHelper do
  ...
  describe '#klass_for' do
    ...
    it 'returns correct klass for Colibri model' do
      klass_for(:products).should == Colibri::Product
      klass_for(:product_properties).should == Colibri::ProductProperty
    end

    it 'returns correct klass for non-colibri model' do
      class MyUser
      end
    ...
    it 'returns correct namespaced klass for non-colibri model' do
      module My
        class User
        end
      end
