...
describe "Order Details", js: true do
  ...
  let!(:product) { create(:product, :name => 'colibri t-shirt', :price => 20.00) }
  ...
  context 'as Admin' do
    ...
    before { visit colibri.edit_admin_order_path(order) }

    context "edit order page" do
      it "should allow me to edit order details" do
        page.should have_content("colibri t-shirt")
      ...
      it "can add an item to a shipment" do
        select2_search "Tote", :from => Colibri.t(:name_or_sku)
      ...
      it "can remove an item from a shipment" do
        ...
        page.should_not have_content("colibri t-shirt")
      end
      ...
      it "can change the shipping method" do
        ...
        visit colibri.edit_admin_order_path(order)
      ...
      context "variant out of stock and not backorderable" do
        ...
        it "displays out of stock instead of add button" do
          ...
          within("table.stock-levels") do
            page.should have_content(Colibri.t(:out_of_stock))
          end
        end
      end
      ...
      context "variant doesn't track inventory" do
        ...
        it "adds variant to order just fine"  do
          select2_search tote.name, :from => Colibri.t(:name_or_sku)
  ...
  context 'with only read permissions' do
    ...
    custom_authorization! do |user|
      can [:admin, :index, :read, :edit], Colibri::Order
    end
  ...
  context 'as Fakedispatch' do
    custom_authorization! do |user|
      # allow dispatch to :admin, :index, and :edit on Colibri::Order
      can [:admin, :edit, :index, :read], Colibri::Order
      # allow dispatch to :index, :show, :create and :update shipments on the admin
      can [:admin, :manage, :read, :ship], Colibri::Shipment
    end

    before do
      Colibri::Api::BaseController.any_instance.stub :try_colibri_current_user => Colibri.user_class.new
    end
