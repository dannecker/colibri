module Colibri
  module Api
    class OrdersController < Colibri::Api::BaseController
      ...
      def create
        ...
        @order = Colibri::Core::Importer::Order.import(current_api_user, order_params)
      ...
      def mine
        if current_api_user.persisted?
          ...
          render "colibri/api/errors/unauthorized", status: :unauthorized
        end
      end
      ...
      def apply_coupon_code
        ...
        render "colibri/api/promotions/handler", :status => status
      end
