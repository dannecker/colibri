module Colibri
  module Api
    class VariantsController < Colibri::Api::BaseController
      ...
      private
        ...
        def product
          @product ||= Colibri::Product.accessible_by(current_ability, :read).friendly.find(params[:product_id]) if params[:product_id]
        end
