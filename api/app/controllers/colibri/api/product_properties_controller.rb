module Colibri
  module Api
    class ProductPropertiesController < Colibri::Api::BaseController
      ...
      private
        ...
        def product_property
          if @product
            ...
            @product_property ||= @product.product_properties.includes(:property).where(colibri_properties: { name: params[:id] }).first
