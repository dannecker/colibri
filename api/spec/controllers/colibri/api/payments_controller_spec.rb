...
module Colibri
  describe Colibri::Api::PaymentsController do
    render_views
      ...
      context "for a given payment" do
        ...
        context "authorizing" do
          ...
          context "authorization fails" do
            before do
              ...
              Colibri::Gateway::Bogus.any_instance.should_receive(:authorize).and_return(fake_response)
              api_put :authorize, :id => payment.to_param
            end
        ...
        context "capturing" do
          ...
          context "capturing fails" do
            before do
              ...
              Colibri::Gateway::Bogus.any_instance.should_receive(:capture).and_return(fake_response)
            end
        ...
        context "purchasing" do
          ...
          context "purchasing fails" do
            before do
              fake_response = double(:success? => false, :to_s => "Insufficient funds")
              Colibri::Gateway::Bogus.any_instance.should_receive(:purchase).and_return(fake_response)
            end
        ...
        context "voiding" do
          ...
          context "voiding fails" do
            before do
              ...
              Colibri::Gateway::Bogus.any_instance.should_receive(:void).and_return(fake_response)
            end
        ...
        context "crediting" do
          ...
          it "can credit" do
            ...
            credit_payment = Payment.where(:source_type => 'Colibri::Payment', :source_id => payment.id).last
          ...
          context "crediting fails" do
            it "returns a 422 status" do
              ...
              Colibri::Gateway::Bogus.any_instance.should_receive(:credit).and_return(fake_response)
              api_put :credit, :id => payment.to_param
              response.status.should == 422
