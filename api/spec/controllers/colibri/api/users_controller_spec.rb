  ...
  describe Api::UsersController do
    ...
    context "as a normal user" do
      ...
      it "can create a new user" do
        api_post :create, :user => { :email => 'new@example.com', :password => 'colibri123', :password_confirmation => 'colibri123' }
      ...
      it "should only get own details on index" do
        ...
        Colibri.user_class.count.should eq 3
    ...
    context "as an admin" do
      ...
      it "gets all users" do
        Colibri::LegacyUser.stub(:find_by).with(hash_including(:colibri_api_key)) { current_api_user }

        2.times { create(:user) }

        api_get :index
        Colibri.user_class.count.should eq 2
      ...
      it 'can query the results through a paramter' do
        expected_result = create(:user, :email => 'brian@colibricommerce.com')
      ...
      it "cannot destroy user with orders" do
        ...
        api_delete :destroy, :id => user.id
        json_response["exception"].should eq "Colibri::Core::DestroyWithOrdersError"
        response.status.should == 422
      end
