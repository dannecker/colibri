...
module Colibri::Api
  describe OrdersController do
    ...
    context "with an available promotion" do
      ...
      let!(:promotion) do 
        promotion = Colibri::Promotion.create(name: "10% off", code: "10off")
        calculator = Colibri::Calculator::FlatPercentItemTotal.create(preferred_flat_percent: "10")
        action = Colibri::Promotion::Actions::CreateItemAdjustments.create(calculator: calculator)
