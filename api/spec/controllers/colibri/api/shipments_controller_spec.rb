...
describe Colibri::Api::ShipmentsController do
  render_views
  ...
  context "as an admin" do
    ...
    it "can make a shipment ready" do
      Colibri::Order.any_instance.stub(:paid? => true, :complete? => true)
      api_put :ready
      json_response.should have_attributes(attributes)
    ...
    it "cannot make a shipment ready if the order is unpaid" do
      Colibri::Order.any_instance.stub(:paid? => false)
      api_put :ready
    ...
    context "can transition a shipment from ready to ship" do
      before do
        ...
        Colibri::ShippingRate.any_instance.stub(:cost => 5)
      end
